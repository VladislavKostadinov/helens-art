...
exit;
         ...
         $sql = "SELECT art2.* FROM art2 WHERE art2.id = '$id'";
...
<!-- <h1 class="book-pic fHeadings" style="color:white;margin-top:50px;"><?php echo $title; ?></h1> -->

<img class="zoomD" src="<?php echo IMG . $img; ?>" />
<div class="book-main">
                 </div></div>
	<?php echo '<br>'?>
    </div> </div> <div id="similiarProjects">
